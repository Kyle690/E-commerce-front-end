...
class admin_email_store
{

    //use PHPMailer\PHPMailer\PHPMailer;
    //use PHPMailer\PHPMailer\Exception;
    function email_admin_contact($name, $email, $message, $db){
        $sql_store_detail = "SELECT * FROM store_details ";
        $result = $db->select($sql_store_detail);
      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader">Good News, Someone wants to get in contact!</span>
            <table class="main">
            <tr>
                    <td align="center">
              ...
              <tr>
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Hi there Team,</p><br>
                        <p>Good news someone wants to get in contact, below are their details.</p><br>
                        <p>Name: '.$name.'</p></br>
                        <p>Email: '.$email.'</p><br>
                        <p>Message: '.$message.'</p>
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">'.$address.', '.$street.', '.$suburb.', '.$city.'</span>
                    <br> Vanita Pasta '.date("Y").' </a>.
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    Sent by <a href="#">Admin Panel</a>.
                  </td>
                </tr>
              </table>
            </div>
...
';
        ...
        $mail->Subject = 'Vanita Pasta Contact Us Enquiry ';
        $mail->Body = "$html";
        ...
        return $msg."Error".$mail->ErrorInfo;
    ...
    function trader_email ($name, $email, $contact, $company_name, $area, $message, $db ){
                ...
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td>
                        <p>Hi there,</p>
                        <p>Good news someone wants to get in contact, below are their details.</p>
                        <p>Name: '.$name.'</p></br>
                        <p>Email: '.$email.'</p><br>
